...
export default {
    ...
    BrainHuman: {
        image: <>
            <path class="st0" d="M84.3,93.8c-0.4-1-1-2-1.7-2.8c-0.4-0.5-0.8-1-1.1-1.6c-0.7-1.3-1.3-2.7-1.7-4.1c-0.9-2.8-1.5-5.7-1.8-8.6
       c-0.5-4.3,0.2-8.7,2-12.7c1.1-2.2,2.5-4.3,4.2-6.2"/>
            <path class="st0" d="M15.7,32.1l-0.1,0.5c-0.3,1.1-0.8,2.2-1.3,3.3c-0.3,0.7-0.6,1.3-0.9,2c-0.4,0.8-0.5,1.6-0.4,2.4
       c0.3,1.3,1.1,2.4,2.2,3.2c0.8,0.7,1.2,1.1,1.3,1.5c-0.1,0.2-0.2,0.4-0.3,0.6c-1.8,3.7-4.1,7.1-6.7,10.3c-1.1,1.3-2.3,2.7-2,4.3
       c0.3,1.1,1.1,2.1,2.2,2.7c0.5,0.3,1,0.6,1.6,0.9c0.7,0.3,1.8,0.9,1.9,1.2c0.1,0.5,0,1-0.2,1.5c-0.2,0.5-0.5,0.8-0.7,1.2
       c-0.6,0.9-1.5,2.5-0.1,3.6c0.3,0.3,0.9,0.7,1.4,1.1c-0.4,0.6-0.6,1.4-0.5,2.1c0.1,0.6,0.4,1.1,0.9,1.4c0.3,0.2,0.7,0.4,1.1,0.6
       c0.9,0.5,1.3,0.7,1.4,1.2c0.1,0.6,0,1.2-0.2,1.8c-0.1,0.4-0.2,0.8-0.2,1.1c-0.2,1.3,0,2.7,0.5,3.9c0.8,2.7,3.7,4.4,6.7,3.8
       c4.4-1,8.7-2.2,13-3.7c3.5,1.9,5.6,7.7,6.2,9.9"/>
            <g>
                <g>
                    <path class="st0" d="M44.5,14.3c0,2.5-2.2,4.5-4.8,4.5c-2.7,0-4.8-2.1-4.8-4.6c0-5.4,6.3-9,12.1-9c3,0,5.8,1,8,2.9
               c0.9,0.7,2.2,0.7,3.2,0c2.3-1.8,5.1-2.8,8.1-2.8C72,5.3,77,9.1,78,14.5c0.3,1.1,1.4,1.9,2.6,1.9c6.5-0.1,11.9,4.8,12,10.9
               c0,1.9-0.6,3.8-1.7,5.4l-15.2-0.1v0c-2.7,0-4.8-2.1-4.8-4.6 M75.8,19c-5.3,0-9.7,4-9.7,9c0,1.6,0.5,3.2,1.3,4.5l-45.5-0.2
               c-1.1-1.6-1.6-3.5-1.6-5.4c0.2-5.3,4.5-9.7,10.1-10.3c1.4,4.8,6.7,7.7,11.8,6.4 M68.3,55.2c0-2.5,2.2-4.5,4.8-4.5
               c2.7,0,4.8,2.1,4.8,4.6c0,5.4-6.3,9-12.1,9c-3,0-5.8-1-8-2.9c-0.9-0.7-2.2-0.7-3.2,0c-2.3,1.8-5.1,2.8-8.1,2.8
               c-5.8,0.1-10.8-3.8-11.8-9.1c-0.3-1.1-1.4-1.9-2.6-1.9c-6.5,0.1-11.9-4.8-12-10.9c0-1.9,0.6-3.8,1.7-5.4L49.2,37
               c2.7,0,4.8,2.1,4.8,4.6c0,2.5-2.2,4.5-4.8,4.5 M57.4,37l33.4,0.2c1.1,1.6,1.6,3.5,1.6,5.4c-0.2,5.3-4.5,9.7-10.1,10.3"/>
                </g>
            </g>
        </>,
        viewBox: "0 0 100 100",
        hideTextInput: true,
        category: [Categories.DATA_MAPPING],
    },
    Nuts: {
        image: <>
            <circle class="st0" cx="50.5" cy="53.2" r="41.7" />
            <path class="st1" d="M61.1,6.1c-2.3-2.3-5.2-3.5-8.4-3.5c-3.2,0-6.2,1.2-8.4,3.5c-4.2,4.2-4.7,12-1.1,16.8l9.6,13.8l9.5-13.8
       C65.7,18.1,65.2,10.3,61.1,6.1z"/>
            <path class="st1" d="M27.5,30.8c-2.3-2.3-5.2-3.5-8.4-3.5c-3.2,0-6.2,1.2-8.4,3.5c-4.2,4.2-4.7,12-1.1,16.8l9.6,13.8l9.5-13.8
       C32.2,42.8,31.7,35,27.5,30.8z"/>
            <g>
                <path class="st2" d="M92.4,48.4c1.8,14.3-3.8,29-15.6,38.3 M66.8,14.9c8.3,3.4,15.6,9.5,20.4,17.8c1.9,3.3,3.3,6.7,4.2,10.2l-4-1
           ...
           c0.3,0.1,0.6,0.2,0.9,0.2"/>
            ...
            <path class="st2" d="M19.2,34.8c-2.4,0-4.4,2-4.4,4.4c0,2.4,2,4.4,4.4,4.4s4.4-2,4.4-4.4S21.6,34.8,19.2,34.8z" />
            <path class="st2" d="M52.7,10.1c-2.4,0-4.4,2-4.4,4.4s2,4.4,4.4,4.4c2.4,0,4.4-2,4.4-4.4S55.1,10.1,52.7,10.1z" />
        </>,
        viewBox: "0 0 100 100",
        hideTextInput: true,
        category: [Categories.DATA_MAPPING],
    ...
    Calender: {
        image: <>
            ...
            <g>
                <path class="st0" d="M7.1,15.9v73.5h86.8V15.9H7.1z M93,32.3H8.4" />
                <line class="st1" x1="30.5" y1="9.5" x2="30.5" y2="23.7" />
                <line class="st1" x1="68.8" y1="9.5" x2="68.8" y2="23.7" />
            </g>
        </>,
        viewBox: "0 0 100 100",
        hideTextInput: true,
    ...
    Unspsc: {
        image: <>
            <path class="st0" d="M38.5,91.8H28.2c-0.2,0-0.4-0.2-0.4-0.4V65.3c0-0.2,0.2-0.4,0.4-0.4h10.4c0.2,0,0.4,0.2,0.4,0.4v26.2
       C38.9,91.6,38.7,91.8,38.5,91.8z"/>
            <path class="st0" d="M18.9,91.8H8.8c-0.2,0-0.4-0.2-0.4-0.4V76.8c0-0.2,0.2-0.4,0.4-0.4h10.1c0.2,0,0.4,0.2,0.4,0.4v14.7
       C19.3,91.6,19.1,91.8,18.9,91.8z"/>
            <path class="st0" d="M18.9,68.5H8.8c-0.2,0-0.4-0.2-0.4-0.4V54.8c0-0.2,0.2-0.4,0.4-0.4h10.1c0.2,0,0.4,0.2,0.4,0.4v13.3
       C19.3,68.3,19.1,68.5,18.9,68.5z"/>
            <path class="st0" d="M92.5,91.8h-9.7c-0.2,0-0.4-0.2-0.4-0.4V76.8c0-0.2,0.2-0.4,0.4-0.4h9.7c0.2,0,0.4,0.2,0.4,0.4v14.7
       C92.9,91.6,92.7,91.8,92.5,91.8z"/>
            <path class="st0" d="M92.5,69.2h-9.7c-0.2,0-0.4-0.2-0.4-0.4V55.6c0-0.2,0.2-0.4,0.4-0.4h9.7c0.2,0,0.4,0.2,0.4,0.4v13.3
       C92.9,69.1,92.7,69.2,92.5,69.2z"/>
            <path class="st0" d="M73.7,91.8h-8.5c-0.2,0-0.4-0.2-0.4-0.4V79.2c0-0.2,0.2-0.4,0.4-0.4h8.5c0.2,0,0.4,0.2,0.4,0.4v12.3
       C74,91.6,73.9,91.8,73.7,91.8z"/>
            <path class="st0" d="M70.2,71.6h-1.6c-2.1,0-3.8-1.7-3.8-3.8v-5.4c0-2.1,1.7-3.8,3.8-3.8h1.6c2.1,0,3.8,1.7,3.8,3.8v5.4
       C74,69.9,72.3,71.6,70.2,71.6z"/>
            <path class="st0" d="M57.3,91.8H47.2c-0.2,0-0.4-0.2-0.4-0.4V62.8c0-0.2,0.2-0.4,0.4-0.4h10.1c0.2,0,0.4,0.2,0.4,0.4v28.6
       C57.7,91.6,57.5,91.8,57.3,91.8z"/>
            <ellipse class="st0" cx="49.3" cy="17.9" rx="8.1" ry="9.5" />
            <path class="st0" d="M28.8,50.8L18.1,34.2l0-0.9c0,0-5.5,0.4-7.7,0c-2.1-0.4-1.9-8.8-1.9-8.8s9.1,0,11,0s4.9,5.8,4.9,5.8l7.8,10.5
