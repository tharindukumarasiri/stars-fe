...
export default function UserManageHome() {
    ...
    return (
        <>
            <div className="g-row m-b-20">
                <TitleCard title={"USERS"} topIcon={"icon-buyer"} />
                <div className="g-col-9 p-l-20">
                    <h4>{t('User Management')}</h4>
                    <div>"Users" Comes with several functionalities.</div>
                    <div>Provides a way to manage the system users</div>
                </div>
            </div>
            <div className="g-row">
                <NavigationCard
